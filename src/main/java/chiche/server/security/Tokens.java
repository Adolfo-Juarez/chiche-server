...
public class Tokens {
    ...
    // Debe tener mímo 256 bits (Al rededor de 64 de carácteres) para evitar cualquier error
     ...
     * @param lifeTime - Tiempo de vida desde la creación en token (en milisegundos).
    ...
    public String generateToken (String id, String subject, String issuer, Long lifeTime){
        ...
        // Más información: https://datatracker.ietf.org/doc/html/draft-ietf-jose-json-web-algorithms-31
