package chiche.server.cookie.controllers;
...
public class CookieController {
    ...
    // Si accedes a localhost:8080/cookie podrás ver el mensaje
    @GetMapping
    public String HelloWorld() {
        return "Hello World, we're in Cookie";
    }
