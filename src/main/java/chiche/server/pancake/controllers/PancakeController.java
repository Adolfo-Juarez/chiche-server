package chiche.server.pancake.controllers;
...
public class PancakeController {
    ...
    // Si accedes a localhost:8080/pancake podrás ver el mensaje
    @GetMapping
    public String HelloWorld() {
        return "Hello World, we're in Pancake";
    }
